    ...
    >
      ...
      {tab === 'geral' ? (
        <>
          ...
          {/* LIBERADO 2026-08-31 (pós corte mestre×jogador e95dcc1): o
              cyberpunk saiu de trás do modo desenvolvedor — o dataset
              público não carrega mais segredo de mestre. */}
